...
; THE STACK POINTER (SP) IS A REFERENCE IN MEMORY!
	LD SP,8000H	; STACK POINTER IS SET TO ADDRESS 8000
	LD HL,255	; SETTING THE HL REGISTER TO VALUE 00FF (HEX)
	LD SP,HL

	;ANOTHER WAY TO SET THE VALUE (WITH MEMORY ADDRESS)
	CALL INITVAL1	; SET SOME VALUE FOR DEMO, CHECK MEMORY EDITOR!

	LD SP,(00F0H)	; LOADING THE VALUE OF ADDRESS 00F0 INTO THE STACKPOINTER
